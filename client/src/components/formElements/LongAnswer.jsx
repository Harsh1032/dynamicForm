...
const LongAnswer = ({ id, isPreview }) => {
  ...
  const [tempTitle, setTempTitle] = useState("Long Answer"); // For temporary title during edit
          ...
          <>
            <div className="w-[93%] min-h-[118px] h-auto rounded-xl border border-[#0000004D] px-4 py-5 space-y-4">
              <span className="font-medium text-xl">
                {componentData.title || "Long Answer"}
                {componentData.isRequired && (
                  <span className="text-red-500">*</span>
                )}
              </span>
              <textarea
                className="w-full h-[102px] p-2 rounded-lg border border-[#0000004D] placeholder:text-[#0000004D] resize-none"
        ...
        <>
          ...
          {open && (
            <div className="w-[93%] h-auto rounded-xl border border-[#0000004D] px-4 py-5 gap-y-4 items-center flex flex-col">
              <textarea
                className="w-[95%] h-[102px] p-2 rounded-lg border border-[#0000004D] placeholder:text-[#0000004D] resize-none"
                placeholder="Text Here"
