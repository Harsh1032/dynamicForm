...
const Options = ({ id, isPreview }) => {
  ...
  const [title, setTitle] = useState("Group of options");
  ...
  return (
    <>
      {isPreview ? (
        <>
          <div className="w-[93%] min-h-[118px] h-auto rounded-xl border border-[#0000004D] px-4 py-5 space-y-2 flex flex-col">
            ...
            {options.length > 0 && (
              <div className="mb-2">
                <div className="grid grid-cols-2 gap-4 mt-2 w-full">
                  {options.map((option, index) => (
                    <div className="bg-[#E0F8EA] py-2 px-4 rounded-[10px] gap-2 min-w-[125px] w-auto flex justify-between items-center gap-x-2">
                      ...
                      {index !== 0 && (
                        <button
                          ...
                          className="bg-gradient-to-r from-[#006838] to-[#96CF24] rounded-full flex items-center justify-center size-5 cursor-not-allowed"
                        >
