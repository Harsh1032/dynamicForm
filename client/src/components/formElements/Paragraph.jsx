...
const Paragraph = ({ id, isPreview }) => {
  ...
  const [tempTitle, setTempTitle] = useState("Paragraph"); // For temporary title during edit
  ...
  return (
    <>
      {isPreview ? (
        <>
          <div className="w-[93%] min-h-[118px] h-auto rounded-xl border-0 py-5 space-y-4">
            <span className="font-medium text-xl">
              {componentData.title || "Paragraph"}
